...
const emptyPayment: PaymentRow = { id: 0, tipo: 'PIX', descricao: '', ativo: true, permiteParcelamento: false, recebeNaEntrega: false, maxParcelas: 1, valorMinimoParcela: 0, instrucoes: '' };
